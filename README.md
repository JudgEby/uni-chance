...
- **Специальности** — добавление направлений внутри факультета с параметрами:
  - План приёма (конкурсные места)
  - Заявлено (автоматически из таблицы распределения баллов)
  - Распределение баллов по 57 диапазонам (396+ до ≤115)
  - «Моя специальность» — по одной на факультет
  - «Подал сюда» — одна на все факультеты, определяет реальное присутствие в таблице
